...
--> statement-breakpoint
CREATE INDEX `connection_user_id_idx` ON `connection` (`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `metric_cache_key_idx` ON `metric_cache` (`connection_id`,`cache_key`);--> statement-breakpoint
